...
> 老东家 Vue，加实习写了两年半~，期间只是简单学过 React，没怎么写过。新东家用 React + Typescript，用了一个半月，写了写[Demo 在线预览](https://wudeh.github.io/study/)。
>
> 这里简单总结下和 vue 的区别，如果你也是在 Vue 转 React 阶段，欢迎加 V 交流[扫码加 V](https://wudeh.github.io/)
>
> 有不同见解，欢迎评论区指教 🤓
...
- 为了提高熟练度，用公司的组件库（[zent](https://youzan.github.io/zent/zh/guides/install)）自己动手写了写，有兴趣的老哥参考下：在线预览:[wudeh 学习系统](https://wudeh.github.io/study/) Github 源码:[基于 react + typescript ](https://github.com/wudeh/react-ts) 欢迎`start`
