...
## 前端常用
* [**onlyoffice-web-local**](https://github.com/sweetwisdom/onlyoffice-web-local) 纯前端实现在线office文件预览编辑
* [**pdfjs-annotation-extension**](https://github.com/Laomai-codefee/pdfjs-annotation-extension) 纯前端实现在线 pdf 预览批注
* [**univer**](https://univer.ai/) 实现在线 excel 文件预览编辑，数据获取
* [**Luckysheet**](https://dream-num.github.io/LuckysheetDocs/zh/guide/#%E5%9F%BA%E6%9C%AC%E4%BB%8B%E7%BB%8D) （不再维护）实现在线 excel 文件预览编辑，数据获取
- [**netlify**](https://www.netlify.com/) 免费静态网站部署，不用梯子
- [**tinypng**](https://tinypng.com/) 图片压缩网站
- [**bignumber**](https://github.com/MikeMcl/bignumber.js) 解决精度计算问题的第三方库
...
- [**shader**](https://www.shadertoy.com/) 着色器相关资源分享
- [**OSM 数据下载**](https://extract.bbbike.org/) 不用科学上网，就是速度比较慢
- [**免费贴图下载**](https://polyhaven.com/zh/textures/terrain) 贴图相关资源分享
- [**3d模型网站**](https://www.pixelsquid.com/) 在线3d模型画画参考
- [**threejs 三维瓦片地图开发框架**](https://sxguojf.github.io/three-tile-doc/) 用 three 实现类似 cesium 效果的框架
- [**echarts案例分享**](https://www.makeapie.cn/echarts) echarts一些炫酷案例
- [**echarts案例分享2**](https://ppchart.com/#/) echarts一些炫酷案例2
- [**香港实景3d模型网站**](https://www.pland.gov.hk/pland_en/info_serv/3D_models/download.htm) 这个网站下载不了，注意下载链接要换成下面的，替换后面的两个数字和格式就行

https://pdmap.pland.gov.hk/PLANDWEB/public/3d_photo_realistic_models/cesium/tile_20_27_CESIUM.zip

- [**shp数据制作3DTiles白膜**](https://blog.csdn.net/lc_2014c/article/details/125538819?spm=1001.2101.3001.6650.6&utm_medium=distribute.pc_relevant.none-task-blog-2~default~BlogCommendFromBaidu~Rate-6-125538819-blog-124988180.pc_relevant_default&depth_1-utm_source=distribute.pc_relevant.none-task-blog-2~default~BlogCommendFromBaidu~Rate-6-125538819-blog-124988180.pc_relevant_default&utm_relevant_index=10) shp数据制作3DTiles白膜
- [**gltf、glb模型在线查看导出**](https://gltf.report/) gltf、glb格式模型导入Threejs材质丢失，因为Threejs新版本不支持某些格式，需要到这个网站导入再导出



## 看剧

- [**在线看剧**](https://www.libre-tv.wangshen.asia/) 咳咳在线看看
