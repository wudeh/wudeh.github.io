  ...
  <ModuleTransition delay="0.5">
    <div v-if="visible" class="kxm-weather-wrapper" :style="{ width }">
      ...
      <div class="weather-footer">
        <div class="tips">欢迎大哥👏🏻扫码加我：<b>wudeh</b></div>
        <div class="qrcode">
          <img v-show="isWechat" :src="$withBase('/img/wx-global.jpg')" alt="公众号" />
          <img v-show="!isWechat" :src="$withBase('/img/wechat.jpg')" alt="微信" />
        </div>
